...
#### Step 13 — Update the Changelog (Role: Release Manager)

Add a new entry to the project's `CHANGELOG.md` that summarizes all changes included in this release. Group entries by type (e.g., **Added**, **Fixed**, **Changed**, **Removed**) and reference the corresponding issue or pull request numbers where applicable.

#### Step 14 — Update the Documentation (Role: Release Manager)
...
#### Step 15 — Create and Publish the Release Tag (Role: Release Manager)
...
#### Step 17 — Communicate the Release (Role: Release Manager)

Announce the new release to the community. This typically includes:

- A post on the O3-Shop website: [https://www.o3-shop.com](https://www.o3-shop.com)
...
| Release | 13. Update the changelog | Release Manager |
| Release | 14. Update the documentation | Release Manager |
| Release | 15. Create and publish the release tag | Release Manager |
| Release | 16. Close the milestone | Release Manager |
| Release | 17. Communicate the release | Release Manager |
